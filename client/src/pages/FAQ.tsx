...
const sections = [
  ...
  { id: "calculation", title: "🧮 Calculation Questions" },
  { id: "features", title: "✨ Feature Questions" },
          ...
          <div className="flex gap-8">
            ...
            <article className="flex-1 max-w-4xl">
              ...
              <div className="space-y-12">
                ...
                {/* Calculation Questions Section */}
                <section id="calculation" className="scroll-mt-24">
                  <h2 className="text-3xl font-bold mb-6">🧮 Calculation Questions</h2>
                ...
                {/* Feature Questions Section */}
                <section id="features" className="scroll-mt-24">
                  <h2 className="text-3xl font-bold mb-6">✨ Feature Questions</h2>
